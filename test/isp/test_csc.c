...
static int test_csc_case(const char *name)
{
    struct test_csc_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_csc_case_disable(void)
{
    return test_csc_case("test_csc_case_disable");
}

static int test_csc_case_enable(void)
{
    return test_csc_case("test_csc_case_enable");
}
