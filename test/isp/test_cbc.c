...
static int test_cbc_case(const char *name)
{
    struct test_cbc_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_cbc_case_disable(void)
{
    return test_cbc_case("test_cbc_case_disable");
}

static int test_cbc_case_enable(void)
{
    return test_cbc_case("test_cbc_case_enable");
}
