...
static int test_ccm_case(const char *name)
{
    struct test_ccm_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_ccm_case_disable(void)
{
    return test_ccm_case("test_ccm_case_disable");
}

static int test_ccm_case_enable(void)
{
    return test_ccm_case("test_ccm_case_enable");
}
