...
static int test_dpc_case(const char *name)
{
    struct test_dpc_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_dpc_case_disable(void)
{
    return test_dpc_case("test_dpc_case_disable");
}

static int test_dpc_case_enable(void)
{
    return test_dpc_case("test_dpc_case_enable");
}
