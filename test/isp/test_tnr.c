...
static int test_tnr_case(const char *name)
{
    struct test_tnr_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_tnr_case_disable(void)
{
    return test_tnr_case("test_tnr_case_disable");
}

static int test_tnr_case_enable(void)
{
    return test_tnr_case("test_tnr_case_enable");
}
