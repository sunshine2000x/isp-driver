...
static int test_hsc_case(const char *name)
{
    struct test_hsc_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_hsc_case_disable(void)
{
    return test_hsc_case("test_hsc_case_disable");
}

static int test_hsc_case_enable(void)
{
    return test_hsc_case("test_hsc_case_enable");
}
