...
static int test_blc_case(const char *name)
{
    struct test_blc_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_blc_case_disable(void)
{
    return test_blc_case("test_blc_case_disable");
}

static int test_blc_case_enable(void)
{
    return test_blc_case("test_blc_case_enable");
}
