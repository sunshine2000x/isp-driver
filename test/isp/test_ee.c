...
static int test_ee_case(const char *name)
{
    struct test_ee_params *params;
    struct isp *isp;
    uint32_t crc;
...
static int test_ee_case_disable(void)
{
    return test_ee_case("test_ee_case_disable");
}

static int test_ee_case_enable(void)
{
    return test_ee_case("test_ee_case_enable");
}
